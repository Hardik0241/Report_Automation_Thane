...
UPDATED: Using THANE_ prefixed secrets for OAuth
...
class GmailReader:
    ...
    def _get_oauth_creds(self):
        ...
        print(f"THANE_CLIENT_ID exists: {bool(os.environ.get('THANE_CLIENT_ID', ''))}")
        print(f"THANE_CLIENT_SECRET exists: {bool(os.environ.get('THANE_CLIENT_SECRET', ''))}")
        print(f"THANE_REFRESH_TOKEN exists: {bool(os.environ.get('THANE_REFRESH_TOKEN', ''))}")

        # UPDATED: Using THANE_ prefixed secrets
        refresh_token = os.environ.get("THANE_REFRESH_TOKEN", "")
        client_id = os.environ.get("THANE_CLIENT_ID", "")
        client_secret = os.environ.get("THANE_CLIENT_SECRET", "")
        ...
        if refresh_token and client_id and client_secret:
            ...
            logger.info("OAuth credentials loaded from environment (THANE)")
            return self._oauth_creds

        print("❌ Missing OAuth credentials!")
        raise Exception("No OAuth credentials found for THANE branch")
